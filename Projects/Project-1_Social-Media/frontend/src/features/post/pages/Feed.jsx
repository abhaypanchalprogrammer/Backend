          ...
          <div className="post">
            <div className="user">
              <div className="img-wrapper">
                <img
                  src="../../../../public/IMG_20260213_1243501.jpg.jpeg"
                  alt=""
                />
              </div>
              <p>Username</p>
            ...
            <img
              src="https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bmF0dXJhfGVufDB8fDB8fHww"
              alt=""
            />
            <div className="icons">
              <div className="left">
